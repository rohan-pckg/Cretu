...
<div class="contact-section" bind:this={contactSection}>
  <div class="contact-content container">
    <div class="heading">
      <h2>Cretu is more than a media company; it’s a movement. We’re here to empower your ideas, magnify your message, and bring your dreams to fruition. Whatever your vision, let’s create it together.
</h2>
    </div>
