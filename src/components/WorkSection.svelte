...
<style lang="scss">
  .work-section {
    ...
    .work-image {
      ...
      &.top-left.is-visible { transition-delay: 0.3s; }
      &.top-right.is-visible { transition-delay: 0.6s; }
      &.bottom-left.is-visible { transition-delay: 0.9s; }
      &.bottom-right.is-visible { transition-delay: 1.2s; }
      &.bottom-center.is-visible { transition-delay: 1.5s; }
    }
  }
