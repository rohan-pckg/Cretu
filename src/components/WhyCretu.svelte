...
<div class="why-us-section container" bind:this={whyUsSection}>
    ...
    <div class="cards-grid">
        <div class="card">
            ...
            <p>
                We’re not just about one piece of the puzzle; we’re here to assemble the whole
                picture, seamlessly integrating all aspects of media and marketing.
            </p>
        </div>
        <div class="card">
            <h3>Expertise You Can Trust</h3>
            <p>
                Our team of seasoned professionals brings years of experience across industries to
                every project.
            </p>
        </div>
        <div class="card">
            ...
            <p>
                We don’t just think outside the box — we reinvent the box entirely. At Cretu,
        ...
        <div class="card">
            ...
            <p>
                Your success is our success. We focus on delivering measurable outcomes that make an
                impact.
            </p>
        </div>
    </div>
